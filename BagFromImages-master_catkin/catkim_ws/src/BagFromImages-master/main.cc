...
int main(int argc, char **argv)
{
    ...
    if(argc!=8)
    {
        cerr << "Usage: rosrun BagFromImages BagFromImages <path to image directory> <image extension .ext> <frequency> <Left keypts & Descriptors> <Right keypts & Descriptors> <path to output bag>" << endl;
        return 0;
    }
    ...
    // Output bag
    rosbag::Bag bag_out(argv[7],rosbag::bagmode::Write);
