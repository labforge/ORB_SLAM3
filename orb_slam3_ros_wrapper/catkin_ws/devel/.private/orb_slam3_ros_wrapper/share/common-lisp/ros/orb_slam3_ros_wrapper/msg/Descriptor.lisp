...
(cl:defmethod cl:initialize-instance :after ((m <Descriptor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Descriptor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name orb_slam3_ros_wrapper-msg:<Descriptor> is deprecated: use orb_slam3_ros_wrapper-msg:Descriptor instead.")))
...
(cl:defmethod rows-val ((m <Descriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:rows-val is deprecated.  Use orb_slam3_ros_wrapper-msg:rows instead.")
  (rows m))

(cl:ensure-generic-function 'cols-val :lambda-list '(m))
(cl:defmethod cols-val ((m <Descriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:cols-val is deprecated.  Use orb_slam3_ros_wrapper-msg:cols instead.")
  (cols m))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <Descriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:type-val is deprecated.  Use orb_slam3_ros_wrapper-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'descdata-val :lambda-list '(m))
(cl:defmethod descdata-val ((m <Descriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:descdata-val is deprecated.  Use orb_slam3_ros_wrapper-msg:descdata instead.")
  (descdata m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Descriptor>)))
  ...
  "orb_slam3_ros_wrapper/Descriptor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Descriptor)))
  "Returns string type for a message object of type 'Descriptor"
  "orb_slam3_ros_wrapper/Descriptor")
