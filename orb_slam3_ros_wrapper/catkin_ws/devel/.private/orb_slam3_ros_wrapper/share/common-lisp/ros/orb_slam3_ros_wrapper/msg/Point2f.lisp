...
(cl:defmethod cl:initialize-instance :after ((m <Point2f>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point2f)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name orb_slam3_ros_wrapper-msg:<Point2f> is deprecated: use orb_slam3_ros_wrapper-msg:Point2f instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Point2f>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:x-val is deprecated.  Use orb_slam3_ros_wrapper-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Point2f>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:y-val is deprecated.  Use orb_slam3_ros_wrapper-msg:y instead.")
  (y m))
