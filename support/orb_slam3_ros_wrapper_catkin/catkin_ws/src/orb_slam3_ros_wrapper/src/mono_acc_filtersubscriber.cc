...
public:
    ...
    void GrabImage(const sensor_msgs::ImageConstPtr& img_msg, const orb_slam3_ros_wrapper::KeyPointsConstPtr& kpts_msg, const orb_slam3_ros_wrapper::DescriptorConstPtr& descs_msg);
...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::Image> image_sub(node_handler, "/camera/image_raw", 1);

    //message_filters::Subscriber<sensor_msgs::Image> image_sub2(nh, "/camera/image_raw", 1);
    message_filters::Subscriber<orb_slam3_ros_wrapper::KeyPoints> keypoints_sub(node_handler, "/camera/keypoints", 1);
    message_filters::Subscriber<orb_slam3_ros_wrapper::Descriptor> descriptors_sub(node_handler, "/camera/descriptors", 1);
    //Both ApproximateTime and ExactTime seem to be working 
    ...
    typedef message_filters::sync_policies::ExactTime<sensor_msgs::Image, orb_slam3_ros_wrapper::KeyPoints, orb_slam3_ros_wrapper::Descriptor> sync_pol;
...
void ImageGrabber::GrabImage(const sensor_msgs::ImageConstPtr& img_msg, const orb_slam3_ros_wrapper::KeyPointsConstPtr& kpts_msg, const orb_slam3_ros_wrapper::DescriptorConstPtr& descs_msg)
{
