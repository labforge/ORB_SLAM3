...
(cl:defclass <KeyPoints> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (keypoints
    :reader keypoints
    :initarg :keypoints
    :type (cl:vector orb_slam3_ros_wrapper-msg:KeyPoint)
   :initform (cl:make-array 0 :element-type 'orb_slam3_ros_wrapper-msg:KeyPoint :initial-element (cl:make-instance 'orb_slam3_ros_wrapper-msg:KeyPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <KeyPoints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyPoints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name orb_slam3_ros_wrapper-msg:<KeyPoints> is deprecated: use orb_slam3_ros_wrapper-msg:KeyPoints instead.")))
...
(cl:defmethod keypoints-val ((m <KeyPoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:keypoints-val is deprecated.  Use orb_slam3_ros_wrapper-msg:keypoints instead.")
  (keypoints m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <KeyPoints>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'keypoints)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'orb_slam3_ros_wrapper-msg:KeyPoint))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<KeyPoints>)))
  ...
  "orb_slam3_ros_wrapper/KeyPoints")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'KeyPoints)))
  "Returns string type for a message object of type 'KeyPoints"
  "orb_slam3_ros_wrapper/KeyPoints")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<KeyPoints>)))
  ...
  (cl:format cl:nil "Header header~%~%KeyPoint[] keypoints~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: orb_slam3_ros_wrapper/KeyPoint~%#class cv::KeyPoint~%#{~%#    Point2f pt;~%#    float size;~%#    float angle;~%#    float response;~%#    int octave;~%#    int class_id;~%#}~%~%Point2f pt~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%================================================================================~%MSG: orb_slam3_ros_wrapper/Point2f~%#class cv::Point2f~%#{~%#    float x;~%#    float y;~%#}~%~%float32 x~%float32 y~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'KeyPoints)))
  "Returns full string definition for message of type 'KeyPoints"
  (cl:format cl:nil "Header header~%~%KeyPoint[] keypoints~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: orb_slam3_ros_wrapper/KeyPoint~%#class cv::KeyPoint~%#{~%#    Point2f pt;~%#    float size;~%#    float angle;~%#    float response;~%#    int octave;~%#    int class_id;~%#}~%~%Point2f pt~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%================================================================================~%MSG: orb_slam3_ros_wrapper/Point2f~%#class cv::Point2f~%#{~%#    float x;~%#    float y;~%#}~%~%float32 x~%float32 y~%~%"))
