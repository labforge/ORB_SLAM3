...
(cl:defclass <KeyPoint> (roslisp-msg-protocol:ros-message)
  ((pt
    :reader pt
    :initarg :pt
    :type orb_slam3_ros_wrapper-msg:Point2f
    :initform (cl:make-instance 'orb_slam3_ros_wrapper-msg:Point2f))
   (size
    :reader size
    :initarg :size
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <KeyPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name orb_slam3_ros_wrapper-msg:<KeyPoint> is deprecated: use orb_slam3_ros_wrapper-msg:KeyPoint instead.")))

(cl:ensure-generic-function 'pt-val :lambda-list '(m))
(cl:defmethod pt-val ((m <KeyPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:pt-val is deprecated.  Use orb_slam3_ros_wrapper-msg:pt instead.")
  (pt m))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <KeyPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:size-val is deprecated.  Use orb_slam3_ros_wrapper-msg:size instead.")
  (size m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <KeyPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:angle-val is deprecated.  Use orb_slam3_ros_wrapper-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <KeyPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:response-val is deprecated.  Use orb_slam3_ros_wrapper-msg:response instead.")
  (response m))

(cl:ensure-generic-function 'octave-val :lambda-list '(m))
(cl:defmethod octave-val ((m <KeyPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:octave-val is deprecated.  Use orb_slam3_ros_wrapper-msg:octave instead.")
  (octave m))

(cl:ensure-generic-function 'class_id-val :lambda-list '(m))
(cl:defmethod class_id-val ((m <KeyPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros_wrapper-msg:class_id-val is deprecated.  Use orb_slam3_ros_wrapper-msg:class_id instead.")
  (class_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<KeyPoint>)))
  ...
  "orb_slam3_ros_wrapper/KeyPoint")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'KeyPoint)))
  "Returns string type for a message object of type 'KeyPoint"
  "orb_slam3_ros_wrapper/KeyPoint")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<KeyPoint>)))
  ...
  (cl:format cl:nil "#class cv::KeyPoint~%#{~%#    Point2f pt;~%#    float size;~%#    float angle;~%#    float response;~%#    int octave;~%#    int class_id;~%#}~%~%Point2f pt~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%================================================================================~%MSG: orb_slam3_ros_wrapper/Point2f~%#class cv::Point2f~%#{~%#    float x;~%#    float y;~%#}~%~%float32 x~%float32 y~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'KeyPoint)))
  "Returns full string definition for message of type 'KeyPoint"
  (cl:format cl:nil "#class cv::KeyPoint~%#{~%#    Point2f pt;~%#    float size;~%#    float angle;~%#    float response;~%#    int octave;~%#    int class_id;~%#}~%~%Point2f pt~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%================================================================================~%MSG: orb_slam3_ros_wrapper/Point2f~%#class cv::Point2f~%#{~%#    float x;~%#    float y;~%#}~%~%float32 x~%float32 y~%~%"))
