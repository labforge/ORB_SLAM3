...
(cl:defmethod cl:initialize-instance :after ((m <Point2f>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point2f)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name BagFromImages-msg:<Point2f> is deprecated: use BagFromImages-msg:Point2f instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Point2f>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader BagFromImages-msg:x-val is deprecated.  Use BagFromImages-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Point2f>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader BagFromImages-msg:y-val is deprecated.  Use BagFromImages-msg:y instead.")
  (y m))
