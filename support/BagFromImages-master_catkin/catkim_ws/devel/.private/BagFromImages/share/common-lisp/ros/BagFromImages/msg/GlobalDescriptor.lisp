...
(cl:defmethod cl:initialize-instance :after ((m <GlobalDescriptor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlobalDescriptor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name BagFromImages-msg:<GlobalDescriptor> is deprecated: use BagFromImages-msg:GlobalDescriptor instead.")))
...
(cl:defmethod data-val ((m <GlobalDescriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader BagFromImages-msg:data-val is deprecated.  Use BagFromImages-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GlobalDescriptor>)))
  ...
  "BagFromImages/GlobalDescriptor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GlobalDescriptor)))
  "Returns string type for a message object of type 'GlobalDescriptor"
  "BagFromImages/GlobalDescriptor")
